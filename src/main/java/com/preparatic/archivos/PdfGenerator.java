...
public class PdfGenerator {
	...
	/**
	 * Añade al test una colecci�n de preguntas.
	 * 
	 * @param resultados
	 */
	...
	private void agregarPregunta(ResultSet resultados) throws Exception {
		...
		// Incorporamos la lista de respuestas en un �nico P�rrafo
	...
	public void guardarPDF() throws Exception {
		...
		// Añadimos las preguntas al documento de preguntas
