...
//  Id pregunta: 492 Año de creación de pregunta: 2016
 questions[1]= "2)  De acuerdo con la Ley 47/2003, de 26 de noviembre, General Presupuestaria, la obligaci&oacute;n de pagar los intereses de la Deuda del Estado y la de devolver los capitales llamados a reembolso, contados respectivamente a partir del vencimiento de los intereses y del d&iacute;a del llamamiento a reembolso prescribir&aacute;:";
 choices[1]= new Array();
 choices[1][0] = "A los cinco a&ntilde;os.";
 choices[1][1] = "A los dos a&ntilde;os.";
 choices[1][2] = "A los tres a&ntilde;os.";
 choices[1][3] = "A los cuatro a&ntilde;os.";
 answers[1] = choices[1][0];
 units[1] = "10";
 comments[1] = "Id Pregunta: 492. PRESUPUESTOS GENERALES";


//  Id pregunta: 459 Año de creación de pregunta: 2016
 questions[2]= "3)  Seg&uacute;n el art&iacute;culo 44.3 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, los cr&eacute;ditos para la acci&oacute;n protectora en su modalidad no contributiva y universal se especificar&aacute;n:";
 choices[2]= new Array();
 choices[2][0] = "A nivel de secci&oacute;n de programa.";
 choices[2][1] = "A nivel de grupo de programa.";
 choices[2][2] = "Ninguna de las respuestas es correcta.";
 choices[2][3] = "A nivel de programa.";
 answers[2] = choices[2][3];
 units[2] = "10";
 comments[2] = "Id Pregunta: 459. PRESUPUESTOS GENERALES";


//  Id pregunta: 504 Año de creación de pregunta: 2016
 questions[3]= "4)  La Ley Org&aacute;nica 2/2012 destaca una serie de principios generales entre los que no se encuentra:";
 choices[3]= new Array();
 choices[3][0] = "Principio de transparencia.";
 choices[3][1] = "Principio de cooperaci&oacute;n.";
 choices[3][2] = "Principio de eficiencia en la asignaci&oacute;n y utilizaci&oacute;n de los recursos p&uacute;blicos.";
 choices[3][3] = "Principio de lealtad institucional.";
 answers[3] = choices[3][1];
 units[3] = "10";
 comments[3] = "Id Pregunta: 504. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 464 Año de creación de pregunta: 2016
 questions[5]= "6)  De acuerdo con lo establecido en la Ley General Presupuestaria, durante el ejercicio presupuestario no es posible modificar la cuant&iacute;a y/o finalidad de los cr&eacute;ditos contenidos en los presupuestos de gastos mediante:";
 choices[5]= new Array();
 choices[5][0] = "Transferencias de cr&eacute;dito.";
 choices[5][1] = "Incorporaciones de cr&eacute;dito.";
 choices[5][2] = "Imputaciones de cr&eacute;dito.";
 choices[5][3] = "Ampliaciones de cr&eacute;dito.";
 answers[5] = choices[5][2];
 units[5] = "10";
 comments[5] = "Id Pregunta: 464. PRESUPUESTOS GENERALES";


//  Id pregunta: 467 Año de creación de pregunta: 2016
 questions[6]= "7)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, los programas plurianuales deber&aacute; de contener:";
 choices[6]= new Array();
 choices[6][0] = "Las respuestas a) y b) son correctas.";
 choices[6][1] = "Las respuestas a) y b) no son correctas.";
 choices[6][2] = "Contenido coherente con los planes sectoriales.";
 choices[6][3] = "Programas de actuaci&oacute;n de existentes en el &aacute;mbito de cada departamento.";
...
//  Id pregunta: 472 Año de creación de pregunta: 2016
 questions[7]= "8)  &iquest;Qui&eacute;n remitir&aacute; a las Cortes Generales un informe trimestral acerca de la utilizaci&oacute;n del Fondo regulado en el Fondo de Contingencia de ejecuci&oacute;n presupuestaria seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria?";
 choices[7]= new Array();
 choices[7][0] = "El Ministro de Econom&iacute;a.";
 choices[7][1] = "El Gobierno.";
 choices[7][2] = "El Ministro de Hacienda y Funci&oacute;n P&uacute;blica.";
 choices[7][3] = "El Presidente del Gobierno.";
...
//  Id pregunta: 450 Año de creación de pregunta: 2016
 questions[8]= "9)  La partida presupuestaria es equivalente a...";
 choices[8]= new Array();
 choices[8][0] = "El sujeto que realiza el gasto";
 choices[8][1] = "El fin que se persigue con la realizaci&oacute;n del gasto";
 choices[8][2] = "El dinero que se asigna a la realizaci&oacute;n del gasto";
 choices[8][3] = "El concepto del gasto, es decir: aquello en lo que se realiza el gasto";
 answers[8] = choices[8][3];
 units[8] = "10";
 comments[8] = "Id Pregunta: 450. PRESUPUESTOS GENERALES";


//  Id pregunta: 487 Año de creación de pregunta: 2016
 questions[9]= "10)  Se&ntilde;ale la respuesta incorrecta respecto de la Ley 47/2003, de 26 de noviembre, General Presupuestaria:";
 choices[9]= new Array();
 choices[9][0] = "El principio de dotaci&oacute;n presupuestaria implica que los Presupuestos Generales del Estado de cada ejercicio contendr&aacute;n los cr&eacute;ditos necesarios para atender a las transferencias de medios econ&oacute;micos que deban realizarse a las comunidades aut&oacute;nomas por aplicaci&oacute;n del sistema de financiaci&oacute;n vigente en cada momento.";
 choices[9][1] = "Los cr&eacute;ditos para hacer efectivas las liquidaciones definitivas de ejercicios anteriores tendr&aacute;n el car&aacute;cter de ampliables.";
 choices[9][2] = "El reintegro de ayudas y la responsabilidad financiera derivados de la gesti&oacute;n de los fondos procedentes de la Uni&oacute;n Europea se someter&aacute; a lo previsto en la Ley General de Subvenciones y en la normativa comunitaria.";
 choices[9][3] = "Los anticipos para ejecuci&oacute;n de acciones y programas financiados o cofinanciados por fondos europeos que estuvieran pendientes de cancelar al finalizar el ejercicio, no podr&aacute;n cancelarse en el ejercicio siguiente.";
...
//  Id pregunta: 500 Año de creación de pregunta: 2016
 questions[11]= "12)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, la Deuda P&uacute;blica podr&aacute; estar representada en:";
 choices[11]= new Array();
 choices[11][0] = "En t&iacute;tulos-valores.";
 choices[11][1] = "Las respuestas a) y b) son correctas.";
 choices[11][2] = "Las respuestas a) y b) no son correctas.";
 choices[11][3] = "En cuenta.";
 answers[11] = choices[11][1];
 units[11] = "10";
 comments[11] = "Id Pregunta: 500. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 463 Año de creación de pregunta: 2016
 ...
 units[12] = "10";
 comments[12] = "Id Pregunta: 463. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 476 Año de creación de pregunta: 2016
 questions[14]= "15)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, los interventores delegados ser&aacute;n designados entre funcionarios de los Cuerpos:";
 choices[14]= new Array();
 choices[14][0] = "Cuerpo Superior de Interventores y Auditores del Estado.";
 choices[14][1] = "Todas las respuestas son correctas.";
 choices[14][2] = "Cuerpo Militar de Intervenci&oacute;n de la Defensa.";
 choices[14][3] = "Cuerpo Superior de Intervenci&oacute;n y Contabilidad de Administraci&oacute;n de la Seguridad Social.";
 answers[14] = choices[14][1];
 units[14] = "10";
 comments[14] = "Id Pregunta: 476. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 494 Año de creación de pregunta: 2016
 ...
 units[15] = "10";
 comments[15] = "Id Pregunta: 494. PRESUPUESTOS GENERALES";


//  Id pregunta: 496 Año de creación de pregunta: 2016
 questions[16]= "17)  Seg&uacute;n la Ley General Presupuestaria, con car&aacute;cter excepcional podr&aacute;n generar cr&eacute;dito en el Presupuesto del ejercicio los ingresos realizados:";
 choices[16]= new Array();
 choices[16][0] = "Por reembolso de pr&eacute;stamos.";
 choices[16][1] = "Por la venta de bienes.";
 choices[16][2] = "En el &uacute;ltimo trimestre del ejercicio anterior.";
 choices[16][3] = "Por prestaci&oacute;n de servicios.";
 answers[16] = choices[16][2];
 units[16] = "10";
 comments[16] = "Id Pregunta: 496. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 499 Año de creación de pregunta: 2016
 ...
 units[17] = "10";
 comments[17] = "Id Pregunta: 499. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 488 Año de creación de pregunta: 2016
 ...
 units[18] = "10";
 comments[18] = "Id Pregunta: 488. PRESUPUESTOS GENERALES";


//  Id pregunta: 491 Año de creación de pregunta: 2016
 questions[19]= "20)  A tenor del art&iacute;culo 47.2 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, el n&uacute;mero de ejercicios a que pueden aplicarse los gastos no ser&aacute; superior a:";
 ...
 units[19] = "10";
 comments[19] = "Id Pregunta: 491. PRESUPUESTOS GENERALES";


//  Id pregunta: 481 Año de creación de pregunta: 2016
 questions[20]= "21)  Conforme a Ley 47/2003, de 26 de noviembre, General Presupuestaria, en el Presupuesto del Estado, los cr&eacute;ditos destinados a atenciones protocolarias y representativas se especificar&aacute;n:";
 choices[20]= new Array();
 choices[20][0] = "A nivel de art&iacute;culo.";
 choices[20][1] = "A nivel de cap&iacute;tulo.";
 choices[20][2] = "Al nivel que corresponda conforme a su concreta clasificaci&oacute;n econ&oacute;mica.";
 choices[20][3] = "A nivel de concepto.";
 answers[20] = choices[20][2];
 units[20] = "10";
 comments[20] = "Id Pregunta: 481. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 455 Año de creación de pregunta: 2016
 questions[22]= "23)  En las Administraciones P&uacute;blicas...";
 choices[22]= new Array();
 choices[22][0] = "Existe un Presupuesto ordinario &uacute;nicamente";
 choices[22][1] = "Existen s&oacute;lo un presupuesto ordinario y un presupuesto extraordinario";
 choices[22][2] = "Existe un &uacute;nico presupuesto ordinario y uno o varios presupuestos extraordinarios";
 choices[22][3] = "Existen varios presupuestos que indistintamente pueden ser considerados ordinarios o extraordinarios";
...
//  Id pregunta: 479 Año de creación de pregunta: 2016
 questions[23]= "24)  Se&ntilde;ale, de acuerdo con la Ley General Presupuestaria, cu&aacute;l de las siguientes afirmaciones es correcta:";
 choices[23]= new Array();
 choices[23][0] = "La Ley General Presupuestaria permite realizar trasferencias de cr&eacute;dito desde el Cap&iacute;tulo 6 de los Presupuestos generales del Estado al Cap&iacute;tulo 2.";
 choices[23][1] = "Es competencia del Consejo de Ministros la autorizaci&oacute;n de generaciones de cr&eacute;dito.";
 choices[23][2] = "Los cr&eacute;ditos extraordinarios por necesidades surgidas en operaciones financieras se financian con Deuda P&uacute;blica o con baja en otros cr&eacute;ditos de la misma naturaleza.";
 choices[23][3] = "Excepcionalmente tendr&aacute;n la condici&oacute;n de ampliables los cr&eacute;ditos destinados al pago de los salarios de los empleados p&uacute;blicos.";
 answers[23] = choices[23][2];
 units[23] = "10";
 comments[23] = "Id Pregunta: 479. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 457 Año de creación de pregunta: 2016
 questions[25]= "26)  La clasificaci&oacute;n econ&oacute;mica del gasto nos dice...";
 choices[25]= new Array();
 choices[25][0] = "En qu&eacute; nos gastamos el dinero";
 choices[25][1] = "Por qu&eacute; nos gastamos el dinero";
 choices[25][2] = "Para qu&eacute; nos gastamos el dinero";
 choices[25][3] = "Qui&eacute;n se gasta el dinero.";
 answers[25] = choices[25][0];
 units[25] = "10";
 comments[25] = "Id Pregunta: 457. PRESUPUESTOS GENERALES";


//  Id pregunta: 501 Año de creación de pregunta: 2016
 questions[26]= "27)  A tenor de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, la cuant&iacute;a global de los anticipos de caja fija no podr&aacute; superar para cada ministerio y organismo aut&oacute;nomo:";
 choices[26]= new Array();
 choices[26][0] = "El 7% del total de cr&eacute;ditos del cap&iacute;tulo destinado a gastos corrientes en bienes y servicios del presupuesto vigente en cada momento.";
 choices[26][1] = "El 5% del total de cr&eacute;ditos del cap&iacute;tulo destinado a gastos corrientes en bienes y servicios del presupuesto vigente en cada momento.";
 choices[26][2] = "El 6% del total de cr&eacute;ditos del cap&iacute;tulo destinado a gastos corrientes en bienes y servicios del presupuesto vigente en cada momento.";
 choices[26][3] = "El 8% del total de cr&eacute;ditos del cap&iacute;tulo destinado a gastos corrientes en bienes y servicios del presupuesto vigente en cada momento.";
 answers[26] = choices[26][0];
 units[26] = "10";
 comments[26] = "Id Pregunta: 501. PRESUPUESTOS GENERALES";


//  Id pregunta: 453 Año de creación de pregunta: 2016
 questions[27]= "28)  En los Presupuestos, &iquest;qu&eacute; es lo que se prev&eacute; liquidar?";
 choices[27]= new Array();
 choices[27][0] = "Los cr&eacute;ditos";
 choices[27][1] = "Las partidas presupuestarias";
 choices[27][2] = "Los derechos";
 choices[27][3] = "Las obligaciones";
 answers[27] = choices[27][2];
 units[27] = "10";
 comments[27] = "Id Pregunta: 453. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 508 Año de creación de pregunta: 2016
 ...
 units[28] = "10";
 comments[28] = "Id Pregunta: 508. PRESUPUESTOS GENERALES";


//  Id pregunta: 449 Año de creación de pregunta: 2016
 questions[29]= "30)  Dentro de la l&oacute;gica presupuestaria, los gastos tienen car&aacute;cter...";
 choices[29]= new Array();
 choices[29][0] = "Ejecutivo";
 choices[29][1] = "Limitativo";
 choices[29][2] = "Estimativo";
 choices[29][3] = "Progresivo";
 answers[29] = choices[29][1];
 units[29] = "10";
 comments[29] = "Id Pregunta: 449. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 493 Año de creación de pregunta: 2016
 questions[31]= "32)  Seg&uacute;n Ley 47/2003, de 26 de noviembre, General Presupuestaria, el conjunto de gastos que se considera necesario realizar en el desarrollo de actividades orientadas a la consecuci&oacute;n de determinados objetivos preestablecidos es:";
 choices[31]= new Array();
 choices[31][0] = "Un programa presupuestario.";
 choices[31][1] = "Un concepto presupuestario.";
 choices[31][2] = "Una aplicaci&oacute;n presupuestaria.";
 choices[31][3] = "Un cr&eacute;dito presupuestario.";
 answers[31] = choices[31][0];
 units[31] = "10";
 comments[31] = "Id Pregunta: 493. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 462 Año de creación de pregunta: 2016
 ...
 units[33] = "10";
 comments[33] = "Id Pregunta: 462. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 483 Año de creación de pregunta: 2016
 questions[38]= "39)  A tenor del art&iacute;culo 48 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, podr&aacute; ser diferido el vencimiento de la obligaci&oacute;n de pago del precio de compra de bienes inmuebles adquiridos directamente cuyo importe excede de:";
 choices[38]= new Array();
 choices[38][0] = "Cuatro millones de euros.";
 choices[38][1] = "Seis millones de euros.";
 choices[38][2] = "Siete millones de euros.";
 choices[38][3] = "Cinco millones de euros.";
 answers[38] = choices[38][1];
 units[38] = "10";
 comments[38] = "Id Pregunta: 483. PRESUPUESTOS GENERALES";


//  Id pregunta: 489 Año de creación de pregunta: 2016
 questions[39]= "40)  Seg&uacute;n el art&iacute;culo 56.6 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, el Ministro de Hacienda dar&aacute; cuentas trimestralmente de los cr&eacute;ditos extraordinarias y suplementos de cr&eacute;dito a:";
 choices[39]= new Array();
 choices[39][0] = "Las Cortes Generales.";
 choices[39][1] = "El Ministerio de Hacienda y Funci&oacute;n P&uacute;blica.";
 choices[39][2] = "El Gobierno.";
 choices[39][3] = "El Congreso de los Diputados.";
 answers[39] = choices[39][0];
 units[39] = "10";
 comments[39] = "Id Pregunta: 489. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 469 Año de creación de pregunta: 2016
 ...
 units[40] = "10";
 comments[40] = "Id Pregunta: 469. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 448 Año de creación de pregunta: 2016
 ...
 units[41] = "10";
 comments[41] = "Id Pregunta: 448. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 474 Año de creación de pregunta: 2016
 questions[43]= "44)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, la modalidad de auditor&iacute;a cuyo objeto consiste en la verificaci&oacute;n selectiva de la adecuaci&oacute;n a la legalidad de la gesti&oacute;n presupuestaria, de contrataci&oacute;n, personal, ingresos y gesti&oacute;n de subvenciones, as&iacute; como de cualquier otro aspecto de la actividad econ&oacute;mico financiero de las entidades auditadas se denomina:";
 choices[43]= new Array();
 choices[43][0] = "Auditor&iacute;a de sistemas y procedimientos de gesti&oacute;n econ&oacute;mica y financiera.";
 choices[43][1] = "Auditor&iacute;a operativa.";
 choices[43][2] = "Auditor&iacute;a de cumplimiento.";
 choices[43][3] = "Auditor&iacute;a de econom&iacute;a, eficacia y eficiencia.";
 answers[43] = choices[43][2];
 units[43] = "10";
 comments[43] = "Id Pregunta: 474. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 480 Año de creación de pregunta: 2016
 questions[45]= "46)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, la funci&oacute;n interventora se ejercer&aacute; en sus modalidades de:";
 choices[45]= new Array();
 choices[45][0] = "Intervenci&oacute;n f&iacute;sica y general.";
 choices[45][1] = "Intervenci&oacute;n formal y material.";
 choices[45][2] = "Intervenci&oacute;n f&iacute;sica y material.";
 choices[45][3] = "Intervenci&oacute;n formal y general.";
...
//  Id pregunta: 477 Año de creación de pregunta: 2016
 questions[46]= "47)  De conformidad con el art&iacute;culo 29.2 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, los programas plurianuales se remitir&aacute;n:";
 choices[46]= new Array();
 choices[46][0] = "Anualmente.";
 choices[46][1] = "Ninguna de las respuestas es correcta.";
 choices[46][2] = "Trimestralmente.";
 choices[46][3] = "Semestralmente.";
 answers[46] = choices[46][0];
 units[46] = "10";
 comments[46] = "Id Pregunta: 477. PRESUPUESTOS GENERALES";


//  Id pregunta: 503 Año de creación de pregunta: 2016
 questions[47]= "48)  De acuerdo con el art&iacute;culo 64 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, qui&eacute;n elaborar&aacute; un presupuesto de explotaci&oacute;n que detallara los recursos y dotaciones anuales correspondientes:";
 choices[47]= new Array();
 choices[47][0] = "Las sociedades mercantiles estatales.";
 choices[47][1] = "Las entidades p&uacute;blicas empresariales.";
 choices[47][2] = "Las respuestas a) y b) son correctas.";
 choices[47][3] = "Las respuestas a) y b) no son correctas.";
 answers[47] = choices[47][2];
 units[47] = "10";
 comments[47] = "Id Pregunta: 503. PRESUPUESTOS GENERALES";


//  Id pregunta: 511 Año de creación de pregunta: 2016
 questions[48]= "49)  A tenor de lo dispuesto en el art&iacute;culo 14 de la Ley Org&aacute;nica 2/2012, de 27 de abril, de Estabilidad Presupuestaria y Sostenibilidad Financiera, el pago de los intereses y el capital de la deuda p&uacute;blica de las Administraciones P&uacute;blicas gozar&aacute; de prioridad:";
 choices[48]= new Array();
 choices[48][0] = "Sobre otros gastos siempre que no superen el 80% del PIB nacional expresados en t&eacute;rminos nominales, o el que se establezca en la normativa europea.";
 choices[48][1] = "Sobre otros gastos siempre que no superen el 70% del PIB nacional expresados en t&eacute;rminos nominales, o el que se establezca en la normativa europea.";
 choices[48][2] = "Absoluta frente a cualquier otro gasto.";
 choices[48][3] = "Sobre otros gastos siempre que no superen el 60% del PIB nacional expresados en t&eacute;rminos nominales, o el que se establezca en la normativa europea";
 answers[48] = choices[48][2];
 units[48] = "10";
 comments[48] = "Id Pregunta: 511. PRESUPUESTOS GENERALES";


//  Id pregunta: 452 Año de creación de pregunta: 2016
 questions[49]= "50)  Los Presupuestos Generales son expresi&oacute;n...";
 choices[49]= new Array();
 choices[49][0] = "Cifrada";
 choices[49][1] = "Conjunta";
 choices[49][2] = "Sistem&aacute;tica";
 choices[49][3] = "Todas son correctas";
 answers[49] = choices[49][3];
 units[49] = "10";
 comments[49] = "Id Pregunta: 452. PRESUPUESTOS GENERALES";


//  Id pregunta: 456 Año de creación de pregunta: 2016
 questions[50]= "51)  El Presupuesto por programas sirve para saber...";
 ...
 units[50] = "10";
 comments[50] = "Id Pregunta: 456. PRESUPUESTOS GENERALES";


//  Id pregunta: 486 Año de creación de pregunta: 2016
 questions[51]= "52)  Seg&uacute;n la Ley 47/2003, de 26 de noviembre, General Presupuestaria, dirigir la contabilidad de las entidades que integran el sistema de la Seguridad Social y gestionar la contabilidad de las entidades gestoras y servicios comunes de la Seguridad Social es una funci&oacute;n de:";
 choices[51]= new Array();
 choices[51][0] = "El Ministerio de Hacienda y Funci&oacute;n P&uacute;blica.";
 choices[51][1] = "La Intervenci&oacute;n General de la Seguridad Social.";
 choices[51][2] = "La Intervenci&oacute;n General de la Administraci&oacute;n del Estado.";
 choices[51][3] = "La Intervenci&oacute;n General de la Defensa.";
 answers[51] = choices[51][2];
 units[51] = "10";
 comments[51] = "Id Pregunta: 486. PRESUPUESTOS GENERALES";


//  Id pregunta: 509 Año de creación de pregunta: 2016
 questions[52]= "53)  De acuerdo con el art&iacute;culo 32 de la Ley Org&aacute;nica 2/2012, de 27 de abril, de Estabilidad Presupuestaria y Sostenibilidad Financiera, en el supuesto de que la liquidaci&oacute;n presupuestaria del Estado se sit&uacute;e en super&aacute;vit, &eacute;ste debe destinarse a:";
 choices[52]= new Array();
 choices[52][0] = "Reducir el gasto p&uacute;blico.";
 choices[52][1] = "Reducir el d&eacute;ficit presupuestario.";
 choices[52][2] = "Reducir el endeudamiento neto.";
 choices[52][3] = "Al Fondo de Contingencia.";
 answers[52] = choices[52][2];
 units[52] = "10";
 comments[52] = "Id Pregunta: 509. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 478 Año de creación de pregunta: 2016
 ...
 units[53] = "10";
 comments[53] = "Id Pregunta: 478. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 451 Año de creación de pregunta: 2016
 ...
 units[55] = "10";
 comments[55] = "Id Pregunta: 451. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 497 Año de creación de pregunta: 2016
 questions[57]= "58)  Seg&uacute;n el art&iacute;culo 13.2 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, el aplazamiento y fraccionamiento de las cantidades adeudadas a la Hacienda P&uacute;blica estatal por las comunidades aut&oacute;nomas y las corporaciones locales se regir&aacute; por:";
 choices[57]= new Array();
 choices[57][0] = "La Ley General Tributaria.";
 choices[57][1] = "La Ley 6/1997, Organizaci&oacute;n y Funcionamiento de la Administraci&oacute;n General del Estado.";
 choices[57][2] = "La legislaci&oacute;n espec&iacute;fica, la cual tendr&aacute; en cuenta la necesaria reciprocidad entre administraciones.";
 choices[57][3] = "La Ley 47/2003, de 26 de noviembre, General Presupuestaria.";
 answers[57] = choices[57][2];
 units[57] = "10";
 comments[57] = "Id Pregunta: 497. PRESUPUESTOS GENERALES";
...
//  Id pregunta: 498 Año de creación de pregunta: 2016
 questions[59]= "60)  A los efectos de la Ley 47/2003, de 26 de noviembre, General Presupuestaria , forman parte del sector p&uacute;blico estatal:";
 choices[59]= new Array();
 choices[59][0] = "Las respuestas a) y b) son correctas.";
 choices[59][1] = "Los organismos aut&oacute;nomos dependientes de la Administraci&oacute;n General del Estado.";
 choices[59][2] = "Las entidades p&uacute;blicas empresariales, dependientes de la Administraci&oacute;n General del Estado, o de cualesquiera otros organismos p&uacute;blicos vinculados o dependientes de ella.";
 choices[59][3] = "Las respuestas a) y b) no son correctas.";
 answers[59] = choices[59][0];
 units[59] = "10";
 comments[59] = "Id Pregunta: 498. PRESUPUESTOS GENERALES";


//  Id pregunta: 506 Año de creación de pregunta: 2016
 questions[60]= "61)  Sobre el per&iacute;odo medio de pagos, se&ntilde;ale la respuesta falsa:";
 choices[60]= new Array();
 choices[60][0] = "Se entiende que existe sostenibilidad de la deuda comercial, cuando el periodo medio de pago a los proveedores no supere el plazo m&aacute;ximo previsto en la normativa sobre morosidad.";
 choices[60][1] = "Este control informatizado y sistematizado de las facturas favorecer&aacute; un seguimiento riguroso de la morosidad a trav&eacute;s de un indicador, el periodo medio de pagos, que visualizar&aacute; el volumen de deuda comercial de las Administraciones P&uacute;blicas.";
 choices[60][2] = "Para el c&aacute;lculo econ&oacute;mico del per&iacute;odo medio de pago a proveedores, se tendr&aacute;n en cuenta las facturas expedidas desde el 1 de enero de 2015 que consten en el registro contable de facturas o sistema equivalente y las certificaciones mensuales de obra aprobadas a partir de la misma fecha.";
 choices[60][3] = "El per&iacute;odo medio de pagos se calcular&aacute; mediante la siguiente f&oacute;rmula: Periodo medio de pago global a proveedores = &Sigma; (periodo medio de pago de cada entidad x importe operaciones de la entidad)/ &Sigma; importe operaciones de las entidades";
 answers[60] = choices[60][2];
 units[60] = "10";
 comments[60] = "Id Pregunta: 506. PRESUPUESTOS GENERALES";


//  Id pregunta: 505 Año de creación de pregunta: 2016
 questions[61]= "62)  Respecto a la Ley Org&aacute;nica 2/2012 se&ntilde;ale la respuesta falsa:";
 choices[61]= new Array();
 choices[61][0] = "La elaboraci&oacute;n, aprobaci&oacute;n y ejecuci&oacute;n de los Presupuestos y dem&aacute;s actuaciones que afecten a los gastos o ingresos de las Administraciones P&uacute;blicas y dem&aacute;s entidades que forman parte del sector p&uacute;blico se someter&aacute; al principio de estabilidad presupuestaria.";
 choices[61][1] = "Ninguna Administraci&oacute;n P&uacute;blica podr&aacute; incurrir en d&eacute;ficit estructural, definido como d&eacute;ficit ajustado del ciclo, neto de medidas excepcionales y temporales.";
 choices[61][2] = "Excepcionalmente, el Estado y las Comunidades Aut&oacute;nomas podr&aacute;n incurrir en d&eacute;ficit estructural en caso de cat&aacute;strofes naturales, recesi&oacute;n econ&oacute;mica grave o situaciones de emergencia extraordinaria que escapen al control de las Administraciones P&uacute;blicas y perjudiquen considerablemente su situaci&oacute;n financiera o su sostenibilidad econ&oacute;mica o social.";
 choices[61][3] = "Las Corporaciones Locales deber&aacute;n mantener una posici&oacute;n de equilibrio presupuestario.";
 answers[61] = choices[61][3];
 units[61] = "10";
 comments[61] = "Id Pregunta: 505. PRESUPUESTOS GENERALES";


//  Id pregunta: 484 Año de creación de pregunta: 2016
 questions[62]= "63)  De acuerdo con el art&iacute;culo 67 de la Ley 47/2003, de 26 de noviembre, General Presupuestaria, si las variaciones afectasen al volumen de endeudamiento a corto y largo plazo, ser&aacute; competencia del Consejo de Ministros cuando su importe exceda de la cuant&iacute;a de:";
 choices[62]= new Array();
 choices[62][0] = "12.000.000 euros de las cifras aprobadas en su presupuesto de capital.";
 choices[62][1] = "13.000.000 euros de las cifras aprobadas en su presupuesto de capital.";
 choices[62][2] = "11.000.000 euros de las cifras aprobadas en su presupuesto de capital.";
 choices[62][3] = "10.000.000 euros de las cifras aprobadas en su presupuesto de capital.";
...
//  Id pregunta: 468 Año de creación de pregunta: 2016
 ...
 units[63] = "10";
 comments[63] = "Id Pregunta: 468. PRESUPUESTOS GENERALES";
